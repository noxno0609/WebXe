namespace WebXe.Migrations
{
    ...
    public partial class Remake : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        PricePublic = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CarModels", "CreatedUserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.CarModels", new[] { "CreatedUserId" });
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.CarTypies");
